...
const EventPage = () => {
  ...
  useEffect(() => {
    ...
    const todaysEvents = universityEventsData.events.filter((event) =>
      event.startTime.startsWith(today)
    );
    setTodayEvents(todaysEvents);

    // Find current or next event
    const currentOrNextEvent = universityEventsData.events.find((event) => {
  ...
  return (
    <div className="bg-gray-100 h-screen w-screen p-4 flex flex-col md:flex-row">
              ...
              <div className="w-full md:w-4/5 flex flex-col space-y-6 md:space-y-8">
                ...
                <div className="w-full md:w-5/6">
                  <div className="flex justify-between text-sm md:text-base mb-2">
                    ...
                    <span>{formatTime(currentEvent.endTime)}</span>
                  </div>
